...
class ControlGoal:
    ...
    wrist_yaw_deg: Optional[float] = None         # Wrist yaw angle in degrees (reBot only)
    # Relative controller rotation since grip start, as quaternion [x,y,z,w] in the
    # VR world frame. Used by reBot 6-DOF pose IK; SO100 ignores it.
    delta_rotation_quat: Optional[np.ndarray] = None
